...
export class AppComponent {
  ...
  produtos: ProdutoModel[] = [
    {
      id: 1,
      nome: '2811 PRETA 60 LEDS/METRO 12V - 1 METRO',
      preco: 21.00,
    ...
    {
      id: 2,
      nome: '2811 BRANCA 60 LEDS/METRO 12V - 1 METRO',
      preco: 21.00,
    ...
    {
      id: 3,
      nome: '2812 PRETA 60 LEDS/METRO 5V - 1 METRO',
      preco: 26.00,
    ...
    {
      id: 4,
      nome: '2815 PRETA 60 LEDS/METRO 12V - 1 METRO',
      preco: 35.00,
    ...
    {
      id: 6,
      nome: '2811 PRETA 144 LEDS/METRO 12V - 1 METRO',
      preco: 71.00,
      urlImagem: 'https://http2.mlstatic.com/D_NQ_NP_915877-MLU69593532219_052023-O.webp'
    },
    {
      id: 7,
      nome: '2811 BRANCA 144 LEDS/METRO 12V - 1 METRO',
      preco: 71.00,
